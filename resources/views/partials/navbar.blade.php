        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a class="flex ml-2 md:mr-24">
                    <img src="{{ asset('assets/static/images/logo.svg') }}" class="h-8 mr-3" alt="FlowBite Logo" />
            ...
            <div class="flex items-center">
                ...
                <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700" id="notification-dropdown">
                    ...
                    <div>
                        ...
                        <div class="flex-shrink-0">
                            <img class="rounded-full w-11 h-11" src="{{ asset('assets/static/images/users/bonnie-green.png') }}" alt="Jese image">
                    ...
                    <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                        <div class="flex-shrink-0">
                            <img class="rounded-full w-11 h-11" src="{{ asset('assets/static/images/users/jese-leos.png') }}" alt="Jese image">
                    ...
                    <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                    <div class="flex-shrink-0">
                        <img class="rounded-full w-11 h-11" src="{{ asset('assets/static/images/users/joseph-mcfall.png') }}" alt="Joseph image">
                ...
                <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                <div class="flex-shrink-0">
                    <img class="rounded-full w-11 h-11" src="{{ asset('assets/static/images/users/leslie-livingston.png') }}" alt="Leslie image">
                    ...
                    <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                        <div class="flex-shrink-0">
                            <img class="rounded-full w-11 h-11" src="{{ asset('assets/static/images/users/robert-brown.png') }}" alt="Robert image">
